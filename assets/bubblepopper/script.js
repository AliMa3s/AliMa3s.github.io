...
playerLeft.src = 'assets/leftFish.png';

const playerRight = new Image();
playerRight.src = 'assets/rightFish.png';
class Player {
    constructor(){
        this.x = canvas.width;
...
bubbleImage.src= 'assets/bub01.png';
class Bubble{
    constructor(){
...
bubblePop1.src = 'Sound/bubble_01.ogg';

const bubblePop2 = document.createElement('audio');
bubblePop2.src = 'Sound/bubble_02.ogg';
